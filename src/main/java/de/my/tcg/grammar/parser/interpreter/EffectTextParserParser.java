...
public class EffectTextParserParser extends Parser {
    ...
    public static final int
            ...
            T__24 = 25, T__25 = 26, T__26 = 27, T__27 = 28, T__28 = 29, Number = 30, WHITESPACE = 31,
            VarPokemonName = 32, DefendingPokemon = 33, AllBenchMons = 34, MyBenchMons = 35,
            PokeType = 36;
    public static final int
            ...
            RULE_benchDmgEffect = 18, RULE_preventAllDmg = 19, RULE_preventEffectAndDmg = 20;
    ...
    private static String[] makeRuleNames() {
        return new String[]{
                ...
                "statusEffect", "discardEnergy", "benchDmgEffect", "preventAllDmg", "preventEffectAndDmg"
        };
    }
    ...
    private static String[] makeSymbolicNames() {
        return new String[]{
                ...
                null, null, null, null, null, null, null, null, null, null, null, null,
                null, null, null, null, null, null, "Number", "WHITESPACE", "VarPokemonName",
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                do {
                    ...
                    _errHandler.sync(this);
                    _la = _input.LA(1);
                } while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 13556425216L) != 0));
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public final PreventEffectAndDmgContext preventEffectAndDmg() throws RecognitionException {
        ...
        enterRule(_localctx, 40, RULE_preventEffectAndDmg);
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(130);
